# Generated by Django 5.0 on 2024-09-14 15:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=255)),
                ('color_hex', models.CharField(help_text='Введите цвет в формате #RRGGBB', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            model_name='door',
            name='tags',
            field=models.ManyToManyField(related_name='doors', to='web.tag'),
        ),
    ]
