...
def generate_unique_number(min_value=1, max_value=22):
    while True:
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        doors = Door.objects.filter(title__icontains="Bravo")
        ...
        for door in doors:
            ...
            new_title = f"Входная металлическая дверь в квартиру Акрон {random_number}"
