...
def generate_unique_number(min_value=1, max_value=3000):
    while True:
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        doors = Door.objects.filter(title__icontains="Лекс")
        ...
        for door in doors:
            ...
            new_title = f"Входная металлическая дверь в квартиру Сенатор {random_number}"
